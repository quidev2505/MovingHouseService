...
function ForgotPasswordAdmin() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post("/v1/adminAccount/forgotPassword", { email_input })
      .then((data) => {
        Toast.fire({
          icon: "success",
        ...
        //Success Sending
        nav("/admin/verify_otp_admin");
        localStorage.setItem("otp_admin", JSON.stringify(email_input));
        // console.log(data);
      })
      .catch((e) => {
        Swal.fire({
